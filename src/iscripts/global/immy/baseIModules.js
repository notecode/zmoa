        ...
        var pop = function (iwidget) {
            ...
            if (dialogOptions) {
                ...
                if (dialogOptions.type == "slideUp") {
                    dialogOptions = $.extend({"pos": "clientCenterBottom", "offset": [0, 25], "className": "slideUp"},dialogOptions);
                } else if (dialogOptions.type == "slideUpAutoClose") {
                    // UI同学说：自动消失的气泡，就不用close按钮了 @2017/05/04
                    dialogOptions = $.extend({"pos": "clientCenterBottom", "offset": [0, 25], "className": "slideUp", "controls": []},dialogOptions);
